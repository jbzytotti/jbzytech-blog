...
export default function ShareButtons({ slug, title }: { slug: string; title: string }) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-sm text-gray-500 dark:text-gray-400 ml-2">مشاركة:</span>
      {shareLinks.map((link) => (
        <a
          key={link.name}
          href={link.href}
          ...
          className="p-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:bg-[#2563EB] hover:text-white transition-all"

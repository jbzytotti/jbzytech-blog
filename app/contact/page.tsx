    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-8">
          يسعدنا تواصلك معنا. يمكنك مراسلتنا عبر البريد الإلكتروني{" "}
          <a href="mailto:jbzytotti@gmail.com" className="text-[#2563EB] hover:underline" dir="ltr">jbzytotti@gmail.com</a>{" "}
          أو عبر نماذج التواصل أدناه.
        </p>
